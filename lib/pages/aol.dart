...
class AolPage extends StatefulWidget {
  const AolPage({Key? key}) : super(key: key);

  @override
  State<AolPage> createState() => _AolPageState();
}
                ...
                TextField(
                  ...
                  onSubmitted: (value) {
                    ...
                    if (url.scheme.isEmpty) {
                      url = WebUri("https://search.aol.com/aol/search?q=$value");
                    }
                    ...
                    child: Stack(
                      children: [
                        InAppWebView(
                          key: webViewKey,
                          initialUrlRequest:
                          URLRequest(url: WebUri("https://search.aol.com/")),
