...
class YahooPage extends StatefulWidget {
  const YahooPage({Key? key}) : super(key: key);
                ...
                TextField(
                  decoration: InputDecoration(
                    ...
                    prefixIcon: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, '/yahood');
                      } ,),
                  ...
                  onSubmitted: (value) {
                    ...
                    if (url.scheme.isEmpty) {
                      url = WebUri("https://search.yahoo.com/search?q=$value");
                    }
                    ...
                    child: Stack(
                      children: [
                        InAppWebView(
                          key: webViewKey,
                          initialUrlRequest:
                          URLRequest(url: WebUri("https://search.yahoo.com/")),
