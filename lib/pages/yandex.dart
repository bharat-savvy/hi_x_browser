...
class YandexPage extends StatefulWidget {
  const YandexPage({Key? key}) : super(key: key);
                ...
                TextField(
                  decoration: InputDecoration(
                    ...
                    prefixIcon: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, '/yandexd');
                      } ,),
                  ...
                  onSubmitted: (value) {
                    ...
                    if (url.scheme.isEmpty) {
                      url = WebUri("https://yandex.com/search/touch/?text=$value");
                    }
                    ...
                    child: Stack(
                      children: [
                        InAppWebView(
                          key: webViewKey,
                          initialUrlRequest:
                          URLRequest(url: WebUri("https://yandex.com/")),
